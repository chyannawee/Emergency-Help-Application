//
//  RecorderCollectionViewController.swift
//  War
//
...
class RecordingsCollectionViewController: UICollectionViewController {
    ...
    //only 1 section is needed in table
    override func numberOfSections(in collectionView: UICollectionView) -> Int {
        return 1
    }
    
    //depending on how many recordings found in array, view all recordings in table
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.recordings.count
    }

    //determine which cell is selected at the moment
    ...
    //bunch of code generated that determines the behaviour of a collection view aka table
